            ...
            <div class="row">
                ...
                <div style="font-size: x-small" class="col d-flex flex-wrap">
                    @foreach ($comics as $comic)
                        <a style="width: 300px;" href="{{ route('comics.show', $comic->id) }}" class="card m-2 p-5 text-decoration-none">
                            ...
                            <img style="width: 150px; aspect-ratio: 1/1; obj-fit: cover" class="card-img-top"
                                src="{{ Str::startsWith($comic->thumb, 'thumb') ? asset('storage/' . $comic->thumb) : $comic->thumb }}"
                                alt="">
